...
class _SubmitLeadScreenState extends State<SubmitLeadScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          _currentStep == 2 ? 'Property Details' :
          _currentStep == 3 ? 'Payment Details' : 'Review',
  ...
  Widget _buildProgressIndicator(bool isSmallScreen) {
    return Container(
      padding: const EdgeInsets.symmetric(vertical: 16, horizontal: isSmallScreen ? 12 : 24),
      child: Row(
        children: [
          ...
          _buildStepCircle(3, 'Payment', isSmallScreen),
          _buildProgressLine(3),
          _buildStepCircle(4, 'Review', isSmallScreen),
        ],
      ),
    );
  }
  ...
  Widget _buildStepContent(bool isSmallScreen) {
    switch (_currentStep) {
      ...
      case 3:
        return _buildPaymentStep(isSmallScreen);
      case 4:
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: Row(
            ...
            children: [
              Text(
                _currentStep == 4 ? 'Submit Lead' : 'Continue to Final Step',
